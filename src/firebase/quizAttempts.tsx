...
export async function getStudentAssessmentAttemptReview(attemptId: string): Promise<QuizAttempt & { reviewAvailable?: boolean; tutorFeedbackAvailable?: boolean }> {
  const callable = httpsCallable<
    { attemptId: string },
    { attempt: QuizAttempt & { reviewAvailable?: boolean; tutorFeedbackAvailable?: boolean } }
  >(functions, "getStudentAssessmentAttemptReview");
