...
export default function CourseCard({ course }: CourseCardProps) {
  const stats = useCourseUnitContentStats(course.id);
  return (
      ...
      <div className="p-6">
        ...
        <div className="mt-5 grid gap-3 text-sm text-slate-600">
          <p className="flex items-center gap-2">
            ...
            Tutor: {course.tutor && course.tutor.toLowerCase() !== "unassigned" ? course.tutor : "Assigned tutor"}
          </p>
          ...
          <p className="flex items-center gap-2">
            <BookOpen size={16} />
            {stats.loading ? "Loading content…" : `${stats.modules} modules • ${stats.lessons} lessons`}
          </p>
