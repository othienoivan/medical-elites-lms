          ...
          <Card>
            ...
            <div className="mt-7 border-t border-slate-200 pt-6">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <Button type="button" variant="outline" onClick={() => updateField("assignedCourseUnitIds", suggestedCourseUnitIds(courseUnits, form.programmeId, form.yearOfStudy, form.semester))}>
