...
export default function CreateLessonPage() {
  ...
  useEffect(() => {
    ...
    const module = modules.find(item => item.id === requestedModuleId);
    if (module?.programmeId) setProgrammeId(module.programmeId);
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const lessonId = await createLesson({
        ...
        institutionId: userProfile?.institutionId ?? selectedModule.institutionId ?? selectedCourseUnit.institutionId ?? null,
