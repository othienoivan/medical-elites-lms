...
export default function ExaminationDetailsPanel(props: Props) {
  return <Card>
    ...
    <div className="mt-6 grid gap-5 md:grid-cols-2">
      ...
      <Field label="Paper Template"><select className="w-full rounded-xl border border-slate-300 px-4 py-3" value={props.template} onChange={e=>props.setTemplate(e.target.value as ExaminationTemplate)}><option value="uhpab">UHPAB (Default)</option><option value="institutional">Institutional</option><option value="nche">NCHE</option><option value="university">University</option></select></Field>
