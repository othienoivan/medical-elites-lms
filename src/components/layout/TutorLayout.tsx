...
const navigation = [
  { name: "Dashboard", icon: Home, path: "/tutor" },
  { name: "Programmes", icon: GraduationCap, path: "/tutor/programmes" },
  { name: "New Programme", icon: GraduationCap, path: "/tutor/programmes/new" },
  { name: "Course Units", icon: BookOpen, path: "/tutor/course-units/new" },
  { name: "Modules", icon: Layers, path: "/tutor/modules" },
  { name: "New Module", icon: Layers, path: "/tutor/modules/new" },
  { name: "Lesson Builder", icon: Presentation, path: "/tutor/lessons/builder" },
  { name: "New Lesson", icon: Presentation, path: "/tutor/lessons/new" },
