    ...
    try {
      ...
      if (targetQuizId) {
        await updateQuiz(targetQuizId, {
          ...
          requiresPassForProgression: true,
          allowRetakesUntilPass: true,
          status: "published",
        });
      } else {
            ...
            {quizRequired && (
              <div className="mt-4 space-y-4">
                ...
                <p className="text-xs leading-5 text-amber-800">
                  For mastery learning, the learner may repeat a quiz configured for repeat-until-pass until this pass mark is attained. The next lesson stays locked until the required score is reached.
                </p>
              </div>
            )}
          </div>
