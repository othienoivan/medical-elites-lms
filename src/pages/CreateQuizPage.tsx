        ...
        <Card className="lg:col-span-2">
          <div className="space-y-6">
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {moduleId && (
                <CheckboxField label="Require pass mark before learner can proceed" checked={requiresPassForProgression} onChange={setRequiresPassForProgression} />
              )}
              {moduleId && requiresPassForProgression && (
                <CheckboxField label="Allow learner to repeat until pass mark is attained" checked={allowRetakesUntilPass} onChange={setAllowRetakesUntilPass} />
              )}
              <CheckboxField
