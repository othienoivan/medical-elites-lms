...
export default defineConfig({
  ...
  server: { watch: { ignored: ["**/*.rar","**/*.zip","**/*.7z","**/*.tar","**/*.gz","**/backups/**","**/Backups/**"] } },
  build: {
    target: "es2022",
    cssCodeSplit: true,
    sourcemap: false,
    ...
    rolldownOptions: { output: { manualChunks(id) {
      ...
      if (id.includes("/src/domains/finance/")) return "finance-domain";
      if (id.includes("/src/pages/platform/")) return "platform-pages";
      return undefined;
    } } }
  }
});
